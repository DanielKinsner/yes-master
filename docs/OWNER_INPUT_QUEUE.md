...
| 2026-09-05 | Listening follow-up 5C naming | **Master filename suffix:** use Album `01-Song__master.wav` to match Track, or align both on `__mastered`? | Existing filenames remain until answered. | Apply the selected convention with source/prior-output protection. |
