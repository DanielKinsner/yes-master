...
- `docs/reviews/2026-06-10-refactor-survey.md` was excluded per the owner
...
- This pair has a bug-ledger history. The 2026-06-02 review found the slow lanes
  ...
  (`docs/reviews/2026-06-02-adaptive-dsp-tier1-review.md:62-65`). The
  ...
  (`docs/reviews/2026-06-05-adaptive-dsp-GLOBAL-review-triage.md:34`,
...
- Review history points to caller-order and stale-state defects around this hook:
  ...
  (`docs/reviews/2026-06-02-adaptive-dsp-tier1-review.md:64-65`), readout/input
  contract drift (`docs/reviews/2026-06-03-adaptive-dsp-FINAL-master-review.md:36-37`),
...
- The 2026-05-29 review identified Rust/TS compressor calibration duplication as
  ...
  (`docs/reviews/2026-05-29-adversarial-review.md:127-133`), and Codex
  validated the drift risk
  (`docs/reviews/2026-05-29-codex-validation-of-master-review.md:54-56`).
...
- Current `SignalChain` still documents manual sync with Rust preset width
  ...
  (`docs/reviews/2026-05-29-codex-validation-of-master-review.md:45-47`).
