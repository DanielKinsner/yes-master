...
| S-02 | Advanced: seven-band EQ, eight styles, width/warmth, Preset/Manual/Off creative compression, custom formats | Hero | Proved | C-06; PRODUCT.md Compressor Canon; AdvancedPanel and VisualEqPanel tests. No active per-band adaptive claim. | Studio redesign |
| S-03 | Same-playhead Original/Mastered; optional Volume Match, off by default, audition-only | Hero | Proved | APP_BEHAVIOR.md Track Master; audio controller tests; C-02. No native timing benchmark claimed. | Studio redesign |
...
| S-05 | Actual export receipt for Lay the Money on the Desk | ProofDeck | Owner-supplied capture | Owner supplied the unchanged export receipt PNG on 2026-09-05 for website publication. Hash, dimensions and session are bound in manifest owner-export-receipt; expandable full capture. Measurements describe this one export, not a guarantee for other tracks. LandingCopy test rejects invented readings/statuses in page copy. | Studio redesign; owner receipt replacement |
| S-06 | Source analysis can ease selected boosts and compression density; already-processed tracks welcome | Workflow | Proved | C-27; PRODUCT.md Adaptive Mastering, reduce-only Tier-1 restraint. Gated per-band/Phase-B logic is not marketed. | Studio redesign |
| S-07 | Four existing character styles share loudness/safety stages; Intensity controls strength | Workflow / SoundCharacter | Proved | C-29; existing preset artwork; preset_fingerprint.rs; supplied owner Intensity capture. Subjective character descriptions, no outcome guarantees. | Studio redesign |
| S-08 | Album Follow/Override, own settings/target under common delivery format; individual/continuous WAVs, manifest, per-track receipts; no DDP/cue/ISRC/gapless guarantee | AlbumProof | Proved | C-30/C-31; PRODUCT.md Album Master; album export integration tests. Actual Album capture expandable; the repetitive delivery diagram was removed in the 2026-09-05 review pass. | Studio redesign |
...
| S-12 | Studio/chassis artwork, with owner-sourced Standard/Advanced displays, separate from HTML copy | Hero | Proved as artwork provenance | Supplied HERO_ASSETS.md; `manifest.json` studioArtwork hashes; standalone asset gate. Owner captures are snapshots, not proof of current native behavior. | Studio redesign |
...
| S-14 | Front-facing blank chassis, tape-machine detail and studio listening scene | Hero / SoundCharacter / FinalCTA | Decorative artwork only | Owner-requested refinement; built-in generation prompts in `docs/landing-mockups/studio-refinement-artwork.md`; manifest hashes. The Advanced screen is a separate HTML image; the 2026-09-05 review pass uses the owner-authorized generated title-cleanup derivative of their WAV screenshot, with the original and prompt preserved in docs/landing-mockups/tightening-review.md. The generated musician is not a customer or testimonial; tape imagery promises no specific hardware emulation. | Studio refinement |
