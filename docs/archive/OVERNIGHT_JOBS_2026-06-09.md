...
> Overnight-jobs runbook executed; Job 1 folded into the 2026-06-10 refactor survey. _(Status: COMPLETE.)_ See docs/CHANGELOG.md for the project ledger.
...
> Write the ranked plan to `docs/archive/reviews/2026-06-10-refactor-survey.md` and
...
- [ ] Read `docs/archive/reviews/2026-06-10-refactor-survey.md` → approve/trim Phase 2 scope
