...
> Codex adversarial source review; key findings actioned, the rest re-tracked in later audits. _(Status: COMPLETE.)_ See docs/CHANGELOG.md for the project ledger.
