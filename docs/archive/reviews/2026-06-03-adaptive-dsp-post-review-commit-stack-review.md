...
> Tier-1 commit-stack mergeability review; merged. Live status in docs/ADAPTIVE_DSP_NEXT_STEPS.md. _(Status: COMPLETE.)_ See docs/CHANGELOG.md for the project ledger.
