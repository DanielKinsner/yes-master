...
> Phase-1 refactor survey; superseded by docs/archive/reviews/2026-06-10-consolidated-refactor-backlog.md (executed in full). _(Status: SUPERSEDED.)_ See docs/CHANGELOG.md for the project ledger.
...
- Commit `f7377f0` "fix(types): close TS↔Rust binding drift" fixed three
  ...
  not CI.
- `docs/archive/reviews/2026-05-29-adversarial-review.md:97` and
...
- `docs/archive/reviews/2026-06-09-export-metrics-inquiry.md:73-76` — the inquiry
...
**Evidence.**
- `docs/archive/reviews/2026-05-29-master-review.md:84` — P2: "Compressor
...
**Evidence.**
- `docs/archive/reviews/2026-05-29-adversarial-review.md` §4 P3 and the Codex
...
**Evidence.**
- `docs/archive/reviews/2026-05-29-adversarial-review.md` §4 P3 ("one-pole envelope
