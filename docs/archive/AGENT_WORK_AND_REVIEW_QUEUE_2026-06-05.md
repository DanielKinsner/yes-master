...
> Agent task queue; self-marked superseded - AGENTS.md + docs/RELEASE_STABILIZATION.md are live. _(Status: SUPERSEDED.)_ See docs/CHANGELOG.md for the project ledger.
...
- docs/ADAPTIVE_DSP_NEXT_STEPS.md
- docs/HANDOFF_2026-06-04_ADAPTIVE_DSP_TIER2_PHASE_B_CONFIDENCE.md
- docs/archive/AGENT_WORK_AND_REVIEW_QUEUE_2026-06-05.md
...
After the review, pick one safe task from docs/archive/AGENT_WORK_AND_REVIEW_QUEUE_2026-06-05.md
...
Use docs/archive/AGENT_WORK_AND_REVIEW_QUEUE_2026-06-05.md as the active task queue.
