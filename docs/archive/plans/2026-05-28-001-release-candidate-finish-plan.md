...
> RC-finish plan executed; superseded by docs/plans/2026-06-12-desktop-shippability-plan.md. _(Status: SUPERSEDED.)_ See docs/CHANGELOG.md for the project ledger.

---
title: YES Master Release Candidate Finish Plan
status: active
created: 2026-05-28
origin: docs/archive/brainstorms/2026-05-28-release-candidate-hardening-requirements.md
...
- `docs/archive/brainstorms/2026-05-28-release-candidate-hardening-requirements.md` - hardened requirements from the brainstorm pass.
...
- `docs/archive/CODEX_WIRING_REVIEW_2026-05-27.md` - historical wiring review; section 1 is mostly consumed, sections 2 and 3 remain useful risk evidence.
...
This plan is ready for implementation, but code work must not start until the user explicitly gives permission in the current session. If resuming from a new window, read this file and `docs/archive/brainstorms/2026-05-28-release-candidate-hardening-requirements.md`, confirm the repo path, then ask before making code edits.
