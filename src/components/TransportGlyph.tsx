...
export function ReturnToStartButton({ onClick }: { onClick: () => void }) {
  return <button type="button" className="icon-btn return-to-start" onClick={onClick}
    aria-label="Return to start" title="Return to start (Home)">
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M6 5v14M18 5l-10 7 10 7Z" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  </button>;
}
